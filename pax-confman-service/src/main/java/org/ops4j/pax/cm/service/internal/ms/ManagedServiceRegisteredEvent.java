...
/**
 * Signals that a ManagedService has been registered.
 *
 * @author Alin Dreghiciu
 * @since 0.3.0, February 22, 2008
 */
public class ManagedServiceRegisteredEvent
    implements Event
{
     ...
     * Logger.
     */
    private static final Log LOG = LogFactory.getLog( ManagedServiceRegisteredEvent.class );
     ...
     */
    public ManagedServiceRegisteredEvent( final String pid )
    {
        NullArgumentException.validateNotNull( pid, "Persistent identifier" );

        m_pid = pid;
        LOG.trace( "Managed Service with service PID " + m_pid + " has been registered" );
    }

    /**
     * Getter.
     *
     * @return service PID; not null
     */
